    ...
    <main className={styles.container}>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            ...
            <tr>
              <td>第2層</td>
              <td>
                判読確信度の低い文字は確定せず、候補を添えて <code>clarifications</code> としてユーザーに質問する
              </td>
              <td>不鮮明文字の誤読</td>
            </tr>
            <tr>
              <td>第3層</td>
              <td>ユーザーの回答も鵜呑みにせず、他の数値・文脈と検算してから受理する（聞き返しループ）</td>
              <td>ユーザー側の入力ミス</td>
            </tr>
          </tbody>
        </table>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.note}>
          ※ ただし照合精度を支える専用ルールは、現時点ではここで一例とする輸入申告業務向けにのみ用意しています。
          そのため輸入申告以外のチェックでは正しい結果を保証できませんが、仕組み自体は汎用のため一定の精度でお試しいただけます。
        </p>
      </section>
