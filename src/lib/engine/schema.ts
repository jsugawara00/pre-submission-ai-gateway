/**
 * 照合エンジンの出力スキーマ（照合エンジン_JSONスキーマ設計_v0.3 準拠）
 *
 * 設計方針:
 ...
 *
 * 参照: docs/照合エンジン_JSONスキーマ設計_v0.3.md（第5章 TypeScript型定義 / 第1章 全体構造）
 */
...
/**
 * field_key の既知の一覧（スキーマ設計v0.3 第3章）。
